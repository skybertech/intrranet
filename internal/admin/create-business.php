...
$GetMax ="SELECT (SELECT MAX(IBSSortOrder) FROM i_business) AS MaxSort";
...
$Query="INSERT INTO i_business(IBSName, IBSLogo, IBSUrl, IBSSortOrder) VALUES('$IBSName', '$target_file', '$IBSUrl', '$Max_sort')";
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="bsname" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="bsurl" class="form-control" required>
                      </div>
                    </div>
