...
$GetMax ="SELECT (SELECT MAX(ISSortorder) FROM i_service) AS MaxSort";
...
$Query="INSERT INTO i_service(ISName, ISDescription, ISImage, ISSortorder) VALUES('$ISName', '$ISDescription', '$target_file', '$Max_sort')";
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="srname" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="file" name="srimage" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        ...
                        <textarea id ="summernote" name="srdescription"></textarea><br>
                      </div>
                    </div>
