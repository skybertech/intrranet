...
$Query="INSERT INTO i_keypercategory(IKeyCatName) VALUES('$IKeyCatName')";
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Create Key Person Category</h4>
                  </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="keypcat" class="form-control" required>
                      </div>
                    </div>
