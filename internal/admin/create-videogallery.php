...
$Query ="SELECT * FROM i_category ORDER BY ICategoryID DESC";
...
$Query="INSERT INTO i_videogallery(IVCat, IVTitle, IVUrl) VALUES('$IVCat', '$IVTitle', '$IVUrl')";
                  ...
                  <form method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="vcname" required>
                          ...
                          <option value="<?php echo $Row['ICategoryID']; ?>"><?php echo $Row['ICName']; ?></option>
                   ...
                   <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="vtitle" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="vurl" class="form-control" required>
                      </div>
                    </div>
