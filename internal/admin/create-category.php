...
if(!isset($_SESSION['Cxyzwet']))
 ...
 $GetMax ="SELECT (SELECT MAX(ICSortOrder) FROM i_category WHERE ICType='Photo') AS PhotoMaxSort, (SELECT MAX(ICSortOrder) FROM i_category WHERE ICType='Video') AS VideoMaxSort, (SELECT MAX(ICSortOrder) FROM i_category WHERE ICType='Both') AS BothMaxSort";
$Resulter_max = $conn->query($GetMax);
$Rower_max = $Resulter_max->fetch_assoc();

$Max_sort_photo=$Rower_max['PhotoMaxSort']+1;
$Max_sort_video=$Rower_max['VideoMaxSort']+1;
$Max_sort_both=$Rower_max['BothMaxSort']+1;
...
if($ICType=='Photo')
{
  $NICSortOrder=$Max_sort_photo;
}
elseif($ICType=='Video')
{
  $NICSortOrder=$Max_sort_video;
}
else
{

$NICSortOrder=$Max_sort_both;
...
$Query="INSERT INTO i_category(ICName, ICImage, ICType, ICSortOrder) VALUES('$ICName', '$target_file', '$ICType', '$NICSortOrder')";
