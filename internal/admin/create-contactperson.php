...
$GetMax ="SELECT (SELECT MAX(IDSortOrder) FROM i_department) AS MaxSort";
...
$Query="INSERT INTO i_department(IDName, IDDEp, IDDesignation, IDPhone, IDEmail, IDSortOrder) VALUES('$IDName', '$IDDEp', '$IDDesignation', '$IDPhone', '$IDEmail', '$Max_sort')";
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="ddesignation" class="form-control" required>
                      </div>
                    </div>
                     ...
                     <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="number" name="dphone" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="email" name="dmail" class="form-control" required>
                      </div>
                    </div>
