...
$Query_C ="SELECT * FROM i_category ORDER BY ICategoryID DESC";
...
$Query="INSERT INTO i_photogallery(IPCat, IPTitle, IPImage, IPDescription) VALUES('$IPCat', '$IPTitle', '$target_file', '$IPDescription')";
                  ...
                  <form method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <select class="form-control selectric" name="pcname" required>
                   ...
                   <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <textarea class="form-control" name="pdescription" rows="100" required></textarea>
                      </div>
                    </div>
