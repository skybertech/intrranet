...
$Queryer ="SELECT * FROM  i_footerlogo WHERE IFTRLOGID='$IFTRLOGID'";
...
$Query="UPDATE i_footerlogo SET IFImage='$target_file' WHERE IFTRLOGID='$IFTRLOGID'";


if ($conn->query($Query) === TRUE) {

echo "<script> alert('Success');window.location.href = 'footer-logo.php';</script>";
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Internal | Footer Logo</title>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4" >
                      ...
                      <div class="col-sm-12 col-md-7">
                        <img src="../uploads/logo-image/<?php echo $Rower['IFImage']; ?>" width="200" style="background: #525658;">
                      </div>
                    </div>
