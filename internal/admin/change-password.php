...
$OldPassword=mysqli_real_escape_string($conn,md5($_POST['oldpass']));
$NewPassword=mysqli_real_escape_string($conn,md5($_POST['newpass']));
$CnfrmPassword=mysqli_real_escape_string($conn,md5($_POST['cnfrmpass']));


$check="SELECT * FROM auth WHERE AuthID='$AdminID'";
$result=mysqli_query($conn,$check);
$c_row=mysqli_fetch_assoc($result);
$Pass=$c_row['AuthPassword'];
...
else
{
  ...
  else 
  {
    ...
    $Query="UPDATE auth SET AuthPassword='$NewPassword' WHERE AuthID='$AdminID'";
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="password" name="cnfrmpass" class="form-control" required>
                      </div>
                    </div>
