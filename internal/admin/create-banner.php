...
$GetMax ="SELECT (SELECT MAX(IBSortOrder) FROM i_banner) AS MaxSort";
...
$Query="INSERT INTO i_banner(IBTitle, IBIMage, IBSortOrder) VALUES('$IBTitle', '$target_file', '$Max_sort')";
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Image (Size: 500 * 330 Px)</label>
                      <div class="col-sm-12 col-md-7">
