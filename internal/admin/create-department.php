...
$Query="INSERT INTO i_department(IDName, IDDesignation, IDPhone) VALUES('$IDName', '$IDDesignation', '$IDPhone')";

if ($conn->query($Query) === TRUE) {

echo "<script> alert('Success');window.location.href = 'manage-departments.php';</script>";
...
<head>
  ...
  <title>Internal | Department</title>
