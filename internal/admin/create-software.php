...
$GetMax ="SELECT (SELECT MAX(SortOrder) FROM i_software) AS MaxSort";
...
$Query="INSERT INTO i_software(ISoftTitle, ISoftImage, ISoftUrl, SortOrder) VALUES('$ISoftTitle', '$target_file','$ISoftUrl','$Max_sort')";
                ...
                <div class="card">
                  ...
                  <form method="POST"  enctype="multipart/form-data">
                   ...
                   <div class="form-group row mb-4">
                    ...
                    <div class="form-group row mb-4">
                      <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Image (Size: 200 * 200 Px)</label>
                      <div class="col-sm-12 col-md-7">
                        <input type="file" name="simage" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="surl" class="form-control" required>
                      </div>
                    </div>
