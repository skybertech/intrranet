...
$target_dir = "../uploads/news-pdf/"; //directory details
...
$Query="UPDATE i_news SET INPDF='$target_file' WHERE INewsID='$INewsID'";
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                          <a href="../uploads/news-pdf/<?php echo $Rower['INPDF']; ?>" target="_blank">View</a>
                      </div>
                    </div>
