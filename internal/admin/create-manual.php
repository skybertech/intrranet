...
$GetMax ="SELECT (SELECT MAX(IMNLSortorder) FROM i_manual) AS MaxSort";
...
$Query="INSERT INTO i_manual(IMNLName, IMNLPDF, IMNLSortorder) VALUES('$IMNLName', '$target_file', '$Max_sort')";
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="mntitle" class="form-control" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="file" name="mnpdf" class="form-control" required>
                      </div>
                    </div>
