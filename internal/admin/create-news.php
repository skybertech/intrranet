...
$GetMax ="SELECT (SELECT MAX(INSortOrder) FROM i_news) AS MaxSort";
...
$Query="INSERT INTO i_news(INTitle, INDescription, INSortOrder) VALUES('$INTitle', '$INDescription', '$Max_sort')";
...
$Query="INSERT INTO i_news(INTitle, INDescription, INImage, INSortOrder) VALUES('$INTitle', '$INDescription', '$target_file', '$Max_sort')";
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-8">
                        <textarea id ="summernote" name="ndescription"></textarea><br>
                      </div>
                    </div>
