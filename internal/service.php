                ...
                <div class="site-heading text-center">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="input-group">
                         ...
                         <button type="button" name="submit" id="submit" class="btn btn-theme effect btn-md" style="background-color: <?php echo $C_color; ?>;margin-left: 10px;" onclick="Getservice()"> Search <i class="fa fa-paper-plane"></i>
                         </button></span>
                         </div>
                    </div>
                </div>
...
<script>
           ...
           xhr.open('POST' , 'getservice.php' , true);
